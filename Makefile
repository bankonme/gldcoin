...
# Generated by qmake (2.01a) (Qt 4.8.2) on: Sat Oct 19 01:07:08 2013
# Project:  bitcoin-qt-nix.pro
# Template: app
# Command: /usr/bin/qmake USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 64BIT=1 -o Makefile bitcoin-qt-nix.pro
#############################################################################
...
Makefile: bitcoin-qt-nix.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 64BIT=1 -o Makefile bitcoin-qt-nix.pro
